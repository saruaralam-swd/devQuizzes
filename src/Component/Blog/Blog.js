...
const Blog = () => {
  return (
    <section className='max-w-3xl mx-auto py-10'>
      <div className='p-4'>
        <h1 className='text-2xl text-[#197fc3] hover:underline cursor-pointer'>#. What is the purpose of react router?</h1>
      ...
      <div className='p-4'>
        <h1 className='text-2xl text-[#197fc3] hover:underline cursor-pointer'>#. How does conText API Works?</h1>
      ...
      <div className='p-4'>
        <h1 className='text-2xl text-[#197fc3] hover:underline cursor-pointer'>#. What is useRef() ?</h1>
